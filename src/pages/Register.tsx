  ...
  if (success) {
    return (
      <div className="min-h-screen bg-heieh-dark flex items-center justify-center px-4">
        ...
        <Card className="neumorph border-white/5 bg-heieh-gray w-full max-w-md">
          <CardHeader className="text-center space-y-4">
            ...
            <CardTitle className="text-white font-heading text-2xl">Check your email</CardTitle>
          ...
          <CardContent className="text-center">
            <Link
              to="/login"
              className="text-heieh-neon-green hover:text-heieh-neon-green/80 transition-colors text-sm"
            >
              Back to login
            </Link>
          </CardContent>
      ...
      <div className="w-full max-w-md relative">
        ...
        <Card className="neumorph border-white/5 bg-heieh-gray">
          <CardHeader className="text-center space-y-4">
            ...
            <CardTitle className="text-white font-heading text-2xl">Create your account</CardTitle>
            <CardDescription className="text-white/50">
          ...
          <CardContent>
            ...
            <p className="text-center mt-6 text-white/40 text-sm">
              ...
              <Link to="/login" className="text-heieh-neon-green hover:text-heieh-neon-green/80 transition-colors">
                Sign in
              </Link>
            </p>
          </CardContent>
